<template>
  <div class="a">
    <ul>
      <li v-for="mov in discoverMovList" :key="mov.id">
        <div class="content_item">
          <div class="dis_userInfo">
            <div class="dis_userCon">
              <a href="#">
                <div class="dis_userimg">
                  <img :src="mov.headimgurl" />
                </div>
              </a>
              <div class="dis_username">{{ mov.nickname }}</div>
            </div>
          </div>
          <div class="ids_article">
            <div style="position:relative">
            <div class="article_img" data-src="#" :style="`background-image: url(${mov.thumb});`" ></div>
            <div class="img_shadow">
              <div class="img_shadow_zzc"></div>
              <div class="img_shadow_con">
                <span>
                  <div>{{mov.create_time | formatDate}}</div>
                </span>
              </div>
            </div>
            </div>
